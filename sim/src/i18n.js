...
const ru = {
  ...
  'param.topRule.used': 'путь: размещение верхних отверстий (T1); V8 crossover, V16 «раздвинута», V22/(11) у верха в режиме uwagake не применяются',
  ...
  'param.topRule.option.uwagake': 'uwagake (умолчание, #54; от прежнего стежка линии, шире на k_top·w; ВРЕМЕННЫЕ k_top, ℓ_uwagake,max)',
  'param.kTop.label': 'uwagake k_top (шаг полуширины за ряд, × w)',
  'param.kTop.used': 'если правило верха = uwagake',
  'param.lBraidMaxW.label': 'uwagake ℓ_uwagake,max (× w)',
  'param.lBraidMaxW.used': 'если правило верха = uwagake (V8)',
...
const en = {
  ...
  'param.topRule.used': 'path: top-hole placement (T1); V8 crossover, V16 “pushed aside”, V22/(11) at the top off in uwagake mode',
  ...
  'param.topRule.option.uwagake': 'uwagake (default, #54; from the previous stitch of the line, k_top·w wider; TEMPORARY k_top, ℓ_uwagake,max)',
  'param.kTop.label': 'Uwagake k_top (half-width step per row, × w)',
  'param.kTop.used': 'if top rule = uwagake',
  'param.lBraidMaxW.label': 'Uwagake ℓ_uwagake,max (× w)',
  'param.lBraidMaxW.used': 'if top rule = uwagake (V8)',
