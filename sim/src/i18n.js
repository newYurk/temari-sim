...
const ru = {
  ...
  'caption.line2': 'обход <b>{round}</b> ({colour}; нить {thread}, ряд {row}): верх s = {sTop} мм, E/X ±{eTop} (замыкающий X {xCl}); низ s = {sBot} мм, E/X ±{eBot}',
  ...
  'len.lift3': 'Плечи этапа: по сфере {sphere} · по оси R + h/2 {axis} (h = {hw}·w — не измерено) · с подъёмом (механика, режим {mode}; +{pct} % к оси)',
  'len.lift3.display': 'Плечи этапа: по сфере {sphere} · по оси R + h/2 {axis} (h = {hw}·w — не измерено) · с подъёмом — н/д (режим display: шатёр только изображение; длина по оси — нижняя граница)',
  ...
  'legend.round': '{id} ({colour}) — нить {thread}, ряд {row}{pending}',
  'colour.blue': 'синий',
  'colour.crimson': 'малиновый',
  'colour.green': 'зелёный',
  'colour.orange': 'оранжевый',
  'colour.violet': 'фиолетовый',
  'colour.teal': 'бирюзовый',
  'colour.brown': 'коричневый',
  'colour.pink': 'розовый',
  'colour.lime': 'салатовый',
  'colour.graphite': 'графитовый',
  'colour.lightBlue': 'голубой',
  'colour.red': 'красный',
  'colour.mustard': 'горчичный',
  'colour.darkTeal': 'тёмно-бирюзовый',
  'colour.purple': 'пурпурный',
  'colour.blueGrey': 'серо-голубой',
  'colour.olive': 'оливковый',
  'colour.yellow': 'жёлтый',
  'colour.hue': 'оттенок {deg}°',
  'op.round': 'обход {round} ({colour})',
  'unit.mm': 'мм',
  'legend.pending': ' (ещё не шит)',
  'legend.lift.display': 'Верхняя нить в перекрёстке приподнята на 0,6·w на уровень стопки — только изображение (режим display; высоты механики — режим ideal).',
  'legend.lift.ideal': 'Подъём верхней нити в перекрёстке — механика (режим ideal): Δ₁ = {d1}·w, шатёр ≈ ±√(2RΔ), мосты между близкими перекрёстками; стопка m ≤ {mmax}, наибольший подъём {dmax} мм. Сечение и жёсткости — оценки, не измерены.',
  'legend.lift.measured': 'Подъём верхней нити в перекрёстке — по измеренному Δ₁ = {d1}·w (режим measured, фото); форма шатра — механика; стопка m ≤ {mmax}, наибольший подъём {dmax} мм.',
  'legend.hidden': 'Скрытые участки — светлее цвета своего обхода; канал иглы E→X — тонкая бледная трубка под всеми нитями.',
...
const en = {
  ...
  'caption.line2': 'round <b>{round}</b> ({colour}; thread {thread}, row {row}): top s = {sTop} mm, E/X ±{eTop} (closing X {xCl}); bottom s = {sBot} mm, E/X ±{eBot}',
  ...
  'len.lift3': 'Stage legs: on the sphere {sphere} · along the axis R + h/2 {axis} (h = {hw}·w — not measured) · with lift (mechanics, mode {mode}; +{pct} % over the axis)',
  'len.lift3.display': 'Stage legs: on the sphere {sphere} · along the axis R + h/2 {axis} (h = {hw}·w — not measured) · with lift — n/a (display mode: the tent is display only; the axis length is the lower bound)',
  ...
  'legend.round': '{id} ({colour}) — thread {thread}, row {row}{pending}',
  'colour.blue': 'blue',
  ...
  'colour.darkTeal': 'dark teal',
  'colour.purple': 'purple',
  'colour.blueGrey': 'blue-grey',
  'colour.olive': 'olive',
  'colour.yellow': 'yellow',
  'colour.hue': 'hue {deg}°',
  'op.round': 'round {round} ({colour})',
  'unit.mm': 'mm',
  'legend.pending': ' (not sewn yet)',
  'legend.lift.display': 'At a crossing the upper thread is raised by 0.6·w to the stack level — display only (display mode; mechanics heights are the ideal mode).',
  'legend.lift.ideal': 'The upper thread lift at a crossing is mechanics (ideal mode): Δ₁ = {d1}·w, tent ≈ ±√(2RΔ), bridges between close crossings; stack m ≤ {mmax}, largest lift {dmax} mm. Cross-section and stiffnesses are estimates, not measured.',
  'legend.lift.measured': 'The upper thread lift at a crossing follows the measured Δ₁ = {d1}·w (measured mode, photo); the tent shape is mechanics; stack m ≤ {mmax}, largest lift {dmax} mm.',
  'legend.hidden': 'Hidden segments are a lighter tint of their round; the needle channel E→X is a thin pale tube under all threads.',
