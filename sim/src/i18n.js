...
const ru = {
  ...
  'param.topRule.option.fan': 'веер (G3: за краем следа самой внешней своей нити + w/2; умолчание до координат)',
  'param.topRule.option.braid': 'косичка (#50 этап A: от прежнего стежка линии, шире на k_top·w; ВРЕМЕННЫЕ k_top, ℓ_braid,max)',
...
const en = {
  ...
  'param.topRule.option.fan': 'fan (G3: beyond the trace edge of the outermost own thread + w/2; default until coordinates)',
  'param.topRule.option.braid': 'braid (#50 stage A: from the previous stitch of the line, k_top·w wider; TEMPORARY k_top, ℓ_braid,max)',
