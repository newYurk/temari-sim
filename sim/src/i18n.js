...
const ru = {
  ...
  'param.topRule.option.fan': 'веер (G3: за краем следа самой внешней своей нити + w/2; режим регрессии S8 и стресса, только при ρ_top ≤ 2)',
...
const en = {
  ...
  'param.topRule.option.fan': 'fan (G3: beyond the trace edge of the outermost own thread + w/2; S8 regression / stress mode, only for ρ_top ≤ 2)',
