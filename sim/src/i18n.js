...
const ru = {
  ...
  'param.topRule.option.braid': 'uwagake (умолчание, #54; id кода braid; от прежнего стежка линии, шире на k_top·w; ВРЕМЕННЫЕ k_top, ℓ_braid,max)',
  'param.kTop.label': 'uwagake k_top (шаг полуширины за ряд, × w)',
  'param.kTop.used': 'если правило верха = uwagake (braid)',
  'param.lBraidMaxW.label': 'uwagake ℓ_braid,max (× w)',
  'param.lBraidMaxW.used': 'если правило верха = uwagake (braid, V8)',
