...
const ru = {
  ...
  'param.wrapThread.info': 'умолчание μ = {mu} ({surface}, полоса {band}); ширина нити ≈ {width} мм. Источник: {source}',
...
const en = {
  ...
  'param.wrapThread.info': 'μ default = {mu} ({surface}, band {band}); thread width ≈ {width} mm. Source: {source}',
