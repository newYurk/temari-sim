...
export const PARAM_SCHEMA = [
  ...
  { key: 'liftMode', group: 'process', label: 'Lift at crossings', type: 'select', def: 'display', options: ['display', 'ideal', 'measured'],
    ...
    basis: '#5 lift-spec v1 §5.4 (model/lift-spec.md); default display until commit 3 of #5', status: 'intent', used: 'render lift, lengths table, V14, V25–V27' },
  ...
  { key: 'bendB_Nmm2', group: 'process', label: 'Thread bending stiffness B, N·mm²', type: 'number', def: 0.01, min: 0.003, max: 0.1, step: 0.001,
    basis: 'lift-spec v1 §2 (c): Peirce bending length 15–25 mm at 200 tex; range 0.003–0.1', status: 'estimate', used: 'lift mechanics: Π, ℓ_b, δ (5–15 %)' },
