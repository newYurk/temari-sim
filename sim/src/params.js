...
export const PARAM_SCHEMA = [
  ...
  { key: 'topRule', group: 'intent', label: 'Top stitch rule', type: 'select', def: 'fan', options: ['fan', 'braid'],
    optionLabels: { fan: 'fan (G3: hole beyond the trace edge of the outermost own thread + w/2; default until coordinates)', braid: 'braid (#50 stage A: from the previous stitch of the line, k_top·w wider; TEMPORARY k_top, ℓ_braid,max)' },
    basis: '#50 Fable delta §5.3 (4) T1–T4; TemariKai «about 1 thread-width wider»; stage A behind the flag, default fan until §7a coordinates (#51)', status: 'intent',
