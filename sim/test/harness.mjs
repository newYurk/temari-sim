...
const GROUP_COST = {
  ...
  '8h': { cost: 20 }, '8i': { cost: 45, uses: [5, 6] }, '8j': { cost: 25 }, '8k': { cost: 12, uses: [5, 6] }, '8l': { cost: 6 }, '8m': { cost: 40 }, '8n': { cost: 45 }, '8o': { cost: 12 }, '8p': { cost: 20 }, '8q': { cost: 10 }, '8r': { cost: 15 }, '8s': { cost: 12 }, 9: { cost: 3 },
};
