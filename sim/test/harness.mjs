...
const GROUP_COST = {
  pre: { cost: 6 }, gl: { cost: 1 }, i18n: { cost: 1 }, '2b': { cost: 4, uses: [9, 10] }, '2c': { cost: 8, uses: [12] }, 3: { cost: 6 }, 4: { cost: 5 }, 5: { cost: 0 }, '5m': { cost: 0 }, '20g': { cost: 8 }, '5i': { cost: 6 }, 6: { cost: 3 },
  ...
  '8h': { cost: 20 }, '8i': { cost: 45, uses: [5, 6] }, '8j': { cost: 25 }, '8k': { cost: 12, uses: [5, 6] }, '8l': { cost: 6 }, '8m': { cost: 40 }, '8n': { cost: 45 }, '8o': { cost: 12 }, '8p': { cost: 20 }, '8q': { cost: 10 }, '8r': { cost: 15 }, '8s': { cost: 12 }, '8t': { cost: 2 }, '8u': { cost: 2 }, '8v': { cost: 4 }, '8w': { cost: 4 }, '8x': { cost: 22 }, '8y': { cost: 4 }, '8z': { cost: 4 }, 9: { cost: 3 },
};
