...
4 ряда на набор до экватора (при фиксированном шаге 2 мм — 11, но с нахлёстом по модели); ряд 1 = 316 мм нити;
≈ 3,6 м на цвет (нижняя оценка). Физика: q = T/R; e^{μθ} = 2,7…26 в захвате; допустимый боковой прогиб плеча 1,5–2,4 мм
